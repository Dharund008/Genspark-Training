...
using CardiologyAppointmentApp.Repositories;
using CardiologyAppointmentApp.Services;
using CardiologyAppointmentApp.Manage;
...
class Program
{
    static void Main(string[] args)
    {
        ...
        ManageAppointment manage = new ManageAppointment(service);
        manage.Start();
    }
}
